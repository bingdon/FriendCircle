...
public class TimeUtility {
	...
	private static String JUST_NOW = FriendApp.getInstance().getString(
			R.string.justnow);
	private static String MIN = FriendApp.getInstance().getString(R.string.min);
	private static String HOUR = FriendApp.getInstance().getString(
			R.string.hour);
	private static String DAY = FriendApp.getInstance().getString(R.string.day);
	private static String MONTH = FriendApp.getInstance().getString(
			R.string.month);
	private static String YEAR = FriendApp.getInstance().getString(
			R.string.year);

	private static String YESTER_DAY = FriendApp.getInstance().getString(
			R.string.yesterday);
	private static String THE_DAY_BEFORE_YESTER_DAY = FriendApp.getInstance()
			.getString(R.string.the_day_before_yesterday);
	private static String TODAY = FriendApp.getInstance().getString(
			R.string.today);

	private static String DATE_FORMAT = FriendApp.getInstance().getString(
			R.string.date_format);
	private static String YEAR_FORMAT = FriendApp.getInstance().getString(
